...
// "Reverse API": the simulation core calls these functions,
// which are generated by the transpiler or written by hand.
extern void initialize_simulation(void);
extern void *get_nets(void);
extern uint32_t get_nets_element_size(void);
extern uint32_t get_nets_element_count(void);
